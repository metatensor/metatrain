...
:ref:`Fine-tuning <label_fine_tuning_concept>`. This section discusses implementation details,
...
.. warning::
  ...
  strategies are discussed in :ref:`Fine-tuning concepts <label_fine_tuning_concept>`.
