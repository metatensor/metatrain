...
NativePET is a cleaner, more user-friendly reimplementation of the original
...
To install NativePET and its dependencies, run the following from the root of the repository:

.. code-block:: bash

    pip install metatrain[nativepet]
...
.. literalinclude:: ../../../src/metatrain/experimental/nativepet/default-hypers.yaml
   :language: yaml

Tuning Hyperparameters
----------------------

NativePET offers a number of tuning knobs for flexibility across datasets:
...
:param name: ``experimental.nativepet``
