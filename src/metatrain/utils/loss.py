...
class FlashMDLoss(LossAggregator):
    ...
    def compute(  # type: ignore
        ...
        scaled_predictions = {}
        scaled_targets = {}
        scaled_predictions["positions"] = flashmd_scale_tensor_map_by_sqrt_masses(
            predictions["positions"], "multiply", all_masses
        )
        scaled_targets["positions"] = flashmd_scale_tensor_map_by_sqrt_masses(
            targets["positions"], "multiply", all_masses
        )
        scaled_predictions["momenta"] = flashmd_scale_tensor_map_by_sqrt_masses(
            predictions["momenta"], "divide", all_masses
        )
        scaled_targets["momenta"] = flashmd_scale_tensor_map_by_sqrt_masses(
