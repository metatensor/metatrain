...
from .utils.transforms import get_radial_training_transform, get_coupling_transform
    ...
    def train(
        ...
        collate_fn = CollateFn(
            ...
            callables=[
                ...
                *([get_coupling_transform(model.max_l)] if model.hypers["sph_basis"] == "coupled" else []),
                get_radial_training_transform(requested_neighbor_lists[0], model),
            ],
