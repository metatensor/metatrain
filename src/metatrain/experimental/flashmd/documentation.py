...
achieves a significant speedup (10-30x) compared to molecular dynamics using MLIPs. The
FlashMD architecture implemented in metatrain is based on the :ref:`PET architecture
<arch-pet>`.
