...
class FlashMDPET(ModelInterface):
    ...
    def forward(
        ...
        # - `momenta` [n_atoms, 3]: The momenta of the central atoms
...
class FlashMD(torch.nn.Module):
    ...
    def __init__(self, model_hypers: dict, dataset_info: DatasetInfo, is_direct: bool = True) -> None:
        ...
        self.model = FlashMDPET(model_hypers, dataset_info)
    ...
    def forward(
        ...
        assert "positions" in outputs.keys()
        assert "momenta" in outputs.keys()
