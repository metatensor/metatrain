...
class PET(ModelInterface[ModelHypers]):
    ...
    def __init__(self, hypers: ModelHypers, dataset_info: DatasetInfo) -> None:
        ...
        self.cutoff_width = (
            float(self.hypers["cutoff_width"])
            if self.hypers["cutoff_width"] is not None
            else None
        )
        ...
        self.cutoff_width_adaptive = (
            float(self.hypers["cutoff_width_adaptive"])
            if self.hypers["cutoff_width_adaptive"] is not None
            else None
        )
